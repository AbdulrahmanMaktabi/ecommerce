...
class ShippingRulesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $editUrl = route('admin.shippingRule.edit', ['shippingRuleID' => $query->id]);
                $destroyUrl = route('admin.shippingRule.delete',  $query->id);
                return "                        
     ...
     */
    public function query(ShippingRules $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('shippingrules-table')
