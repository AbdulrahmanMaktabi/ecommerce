        ...
        <div class="row">
            <div class="col-12 ">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.flashSale.update', ['flashSaleID' => $flashSale->id]) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"> <label for="">Status</label>
                                    <select name="status" id="" class="form-control">
                                        <option value="1" {{ $flashSale->status == '1' ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0" {{ $flashSale->status == '1' ? '' : 'selected' }}>Inactive
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-6"> <label for="">Show On Home Page</label>
                                    <select name="show_on_home" id="" class="form-control">
                                        <option value="1" {{ $flashSale->show_on_home == '1' ? 'selected' : '' }}>Yes
                                        </option>
                                        <option value="0" {{ $flashSale->show_on_home == '1' ? '' : 'selected' }}>No
                                        </option>
                                    </select>
                                </div>
                            </div>
