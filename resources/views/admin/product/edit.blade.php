                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.update', ['product' => $product->id]) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="long_description" class="summernote" id="" cols="30" rows="10">{{ $product->long_description }}</textarea>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3"> <label for="">is top</label>
                                        <select name="is_top" id="" class="form-control">
                                            <option value="1" {{ $product->is_top == '1' ? 'selected' : '' }}>Active
                                            </option>
                                    ...
                                    <div class="col-md-3"> <label for="">is best</label>
                                        <select name="is_best" id="" class="form-control">
                                            <option value="1" {{ $product->is_best == '1' ? 'selected' : '' }}>Active
                                            </option>
                                    ...
                                    <div class="col-md-3"> <label for="">is featured</label>
                                        <select name="is_featured" id="" class="form-control">
                                            ...
                                            <option value="0" {{ $product->is_featured == '1' ? '' : 'selected' }}>
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-3"> <label for="">is approved</label>
                                        <select name="is_approved" id="" class="form-control">
                                            <option value="1" {{ $product->is_approved == '1' ? 'selected' : '' }}>
                                                Active
                                            </option>
                                            <option value="0" {{ $product->is_approved == '1' ? '' : 'selected' }}>
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="seo_description" class="summernote" id="" cols="30" rows="10">{{ $product->seo_description }}</textarea>
                            </div>
