...
@section('content')
    ...
    <div class="wsus__dashboard_add wsus__add_address">
        <form method="POST" action="{{ route('address.update', ['addressID' => $address->id]) }}">
            @csrf
            @method('put')
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="wsus__add_address_single">
                        <label>address</label>
                        <textarea cols="3" rows="5" placeholder="Type Your Address" name="address">{{ $address->address }}"</textarea>
                    </div>
                </div>
                <div class="col-xl-6">
                    <button type="submit" class="common_btn">Edit</button>
                </div>
            </div>
        </form>
    </div>
