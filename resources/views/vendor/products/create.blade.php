                            ...
                            <form action="{{ route('vendor.product.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"> <label for="">Product Short Description</label>
                                            <input type="text" name="short_description" class="form-control"
                                                id="" value="{{ @old('short_description') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="wsus__dash_pro_single">
                                        <textarea name="long_description" class="form-control" id="" cols="30" rows="5">{{ @old('long_description') }}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3"> <label for="">is top</label>
                                            <select name="is_top" id="" class="form-control">
                                                <option value="1" {{ @old('is_top') == '1' ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="0" {{ @old('is_top') == '1' ? '' : 'selected' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-3"> <label for="">is best</label>
                                            <select name="is_best" id="" class="form-control">
                                                <option value="1" {{ @old('is_best') == '1' ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="0" {{ @old('is_best') == '1' ? '' : 'selected' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="wsus__dash_pro_single">
                                        <textarea name="seo_description" class="form-control" id="" cols="30" rows="5">{{ @old('seo_description') }}</textarea>
                                    </div>
                                </div>
