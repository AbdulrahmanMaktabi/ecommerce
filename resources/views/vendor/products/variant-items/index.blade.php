        ...
        <div class="wsus__dash_pro_area">
            <div class="row">
                <div class="create-btn">
                    <a href="{{ route('vendor.variant.items.create', ['variant_id' => $variant->id]) }}"
                        class="btn btn-primary">Create Item For {{ $variant->name }}
        ...
        <script>
            $(document).ready(function() {
                ...
                $('body').on('change', '.custom-switch-input', function() {
                    ...
                    // Send AJAX request
                    $.ajax({
                        url: "{{ route('vendor.variant.items.update.status') }}", // Define your route for updating status
                        type: "POST",
                        data: {
                            id: id,
                            status: status,
